 ...
 * @author nrc
 */
public class BeamRenderer_TEMP {

    IBeamSteeringConfig beamSteeringConfig;

    public BeamRenderer_TEMP(IBeamSteeringConfig beamSteeringConfig) {
    ...
    private void drawUpperOpticalSlide(Graphics g) {
        ...
        if (topOpticalSlideConfig.getPosition() == IOpticalSlideConfig.POSITION_CLEAR) {
            drawDichroic(g, Color.blue, true, BeamStearingElementsFactory.TOP_SLIDE, true, BeamStearingElementsFactory.DONT_CARE, 0, 0); //clear
            ...
            drawDichroic(g, Color.blue, true, BeamStearingElementsFactory.TOP_SLIDE, true, BeamStearingElementsFactory.DONT_CARE, +1, -1); //clear
            ...
            drawDichroic(g, Color.blue, true, BeamStearingElementsFactory.TOP_SLIDE, true, BeamStearingElementsFactory.DONT_CARE, +2, -2); //clear
            drawDichroic(g, Color.black, true, BeamStearingElementsFactory.TOP_SLIDE, false, BeamStearingElementsFactory.DONT_CARE, +1, -1); //mirror
    ...
    private void drawLowerOpticalSlide(Graphics g) {
        ...
        } else if (bottomOpticalSlideConfig.getPosition() == IOpticalSlideConfig.POSITION_CLEAR) {
            //red blue
    ...
    /*
        ...
        if (beamSteeringConfig.getUpperSlideConfig().getPosition() == IOpticalSlideConfig.POSITION_CLEAR) {
            Polygon incomingToTipTilt = BeamStearingElementsFactory.getInstance().getBeam_Incoming_to_TopSlide();
            g.setColor(Color.lightGray);
            g.fillPolygon(incomingToTipTilt);

            if (beamSteeringConfig.getLowerSlideConfig().getPosition() == IOpticalSlideConfig.POSITION_CLEAR) {
                Polygon tipTiltToTHOR = BeamStearingElementsFactory.getInstance().getBeam_TipTilt_to_THOR();
                g.setColor(Color.lightGray);
                g.fillPolygon(tipTiltToTHOR);
            } else {
        ...
        } else if (beamSteeringConfig.getLowerSlideConfig().getPosition() == IOpticalSlideConfig.POSITION_CLEAR) {
