 ...
 * @author nrc
 */
public class PickLOTUSConfigDialog extends javax.swing.JDialog {

    static Logger logger = Logger.getLogger(PickLOTUSConfigDialog.class);

    private XBlueTwoSlitSpectrographInstrumentConfig instrumentConfig;
    private IProgram program;
    private ArrayList configsInProgram = new ArrayList();

    public PickLOTUSConfigDialog(boolean modal, IProgram program) {
        this.setModal(modal);
    ...
    private void populateComponents() {
        //get LOTUS instrument configs in programme and populate jcbInstrumentConfigNames and LOTUSConfigsInProgram list
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (instrumentConfig instanceof XBlueTwoSlitSpectrographInstrumentConfig) {
                    ...
                    configsInProgram.add(blueTwoSlitSpectrographInstrumentConfig);
                    jcbInstrumentConfigNames.addItem(blueTwoSlitSpectrographInstrumentConfig.getName());
                }
            }
        ...
        jlblWarnOfNoConfigs.setVisible(configsInProgram.size() == 0);
        jbtnCreate.setEnabled(configsInProgram.size() != 0);
    }
    ...
    private void centerFrame() {
        ...
        EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        PickLOTUSConfigDialog.this.setLocation(x, y);
                    }
                });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LOTUS Configuration");
        ...
        jlblWarnOfNoConfigs.setText("NO LOTUS CONFIGS HAVE BEEN SET UP");
...
private void jbtnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCreateActionPerformed
    ...
    instrumentConfig = (XBlueTwoSlitSpectrographInstrumentConfig) configsInProgram.get(selectedIndex);
...
public XBlueTwoSlitSpectrographInstrumentConfig getConfig() {
